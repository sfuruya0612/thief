...
func (s *Server) registerRoutes() {
	...
	s.mux.HandleFunc("POST /api/aws/profiles/{profile}/ssm/parameters", s.handleSSMPut)
	s.mux.HandleFunc("GET /api/aws/profiles/{profile}/secretsmanager", s.handleSecretsList)
	s.mux.HandleFunc("GET /api/aws/profiles/{profile}/secretsmanager/value", s.handleSecretValue)
	s.mux.HandleFunc("POST /api/aws/profiles/{profile}/secretsmanager", s.handleSecretsPut)
